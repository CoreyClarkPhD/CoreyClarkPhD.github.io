...
BattleGame = {
	...
	LoadQuestions: function(){
		...
		BattleGame.Questions[2] = new CQuestion("Which do you enjoy more in MUD quests", BattleGame.Answers[2]);	

			//Question 4
		BattleGame.Answers[3] =[ new COption("Your equipment", "achiever", 1),
				  				 new COption("Your personality", "socializer", 1) ];
		BattleGame.Questions[3] = new CQuestion("Which would you rather be noticed for on a MUD", BattleGame.Answers[3]);	
		...
		BattleGame.Questions[5] = new CQuestion("Which do you enjoy more on a MUD", BattleGame.Answers[5]);	
		...
		BattleGame.Questions[6] = new CQuestion("Which would you rather have, as a player on a MUD", BattleGame.Answers[6]);	
		...
		BattleGame.Questions[7] = new CQuestion("Which would you enjoy more as a MUD player", BattleGame.Answers[7]);	

			//Question 9
		BattleGame.Answers[8] =[ new COption("The number of people", "socializer", 1),
				  				 new COption("The number of areas to explore", "explorer", 1) ];
		BattleGame.Questions[8] = new CQuestion("What's more important in a MUD to you", BattleGame.Answers[8]);	

			//Question 10
		BattleGame.Answers[9] =[ new COption("The quality of roleplaying in a MUD", "socializer", 1),
		...
		BattleGame.Questions[10] = new CQuestion("You are being chased by a monster on a MUD, Do you", BattleGame.Answers[10]);	
		...
		BattleGame.Questions[12] = new CQuestion("You're a player on a mud, and about to go into an unknown dungeon. You have your choice of one more person for your party.", BattleGame.Answers[12]);	
		...
		BattleGame.Questions[20] = new CQuestion("On a MUD, a new area opens up. Which do you look forward to more?", BattleGame.Answers[20]);
		...
		BattleGame.Questions[21] = new CQuestion("On a MUD, would you rather be known as:", BattleGame.Answers[21]);
		...
		BattleGame.Questions[26] = new CQuestion("On a MUD, would rather join a clan of:", BattleGame.Answers[26]);
		...
		BattleGame.Questions[29] = new CQuestion("On a MUD, would rather be known for", BattleGame.Answers[29]);
	...
	AddHTMLQuestions: function(){
		...
		for(var i = 0; i < BattleGame.Questions.length; i++){
			...
			html += 	"<div id='"+ id +"' class='well'>" +
							...
							'<div class="row">' +
							  '<div class="col-md-12">' +
							  	'<button type="button" class="btn btn-primary btn-lg">' + option1  + '</button>' +
							  '</div>' +
							'</div>' +  
							'<div class="row">' +
							  '<div class="col-md-6">' +
							  	'<button type="button" class="btn btn-primary btn-lg">' + option2 + '</button>' +
							  '</div>' +
							'</div>' +
							'</div>' +
						'</div>';
